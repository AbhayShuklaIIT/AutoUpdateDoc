...
prompt = "Give me ONLY the parts that needed to be added at API section (I am trying to add forecast api endpoint) that will be directly linked to this PRD - "+pr_body + "\n\n This is the support doc" + support_doc + "\n\n Always highlight the part that is proposed for addition" 
